   ...
   */
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: ICONS.product,
        children: [
          { title: 'List', path: paths.dashboard.plan.root },
          { title: 'Create', path: paths.dashboard.plan.new },
          // { title: 'Edit', path: paths.dashboard.plan.demo.edit },
        ],
      },
    {
      title: 'Company',
      ...
      children: [
        ...
        // { title: 'Cards', path: paths.dashboard.company.cards },
      ],
    },
